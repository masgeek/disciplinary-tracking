...
/**
 * This is the model class for table "{{%CASE_INCIDENCES}}".
 *
...
class CASEINCIDENCES extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['INCIDENCE_ID', 'STUDENT_REG_NO', 'CASE_DESCRIPTION', 'STATUS_CODE', 'REPORTED_BY', 'DATE_REPORTED', 'DATE_ADDED'], 'required'],
